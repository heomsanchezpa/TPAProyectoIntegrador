        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group">
                    ...
                    <input class="hidden" id="materiaid" name="materiaid"/>
                    <input class="form-control" type="text" id="clavemateria2" name="clavemateria2" placeholder="Ingrese la clave de la materia">
                </div>
            </div>
        ...
        <form id="frmMateria" method="POST">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" id="clavemateria" name="clavemateria" placeholder="Ingrese la clave de la materia">
                </div>
            </div>
