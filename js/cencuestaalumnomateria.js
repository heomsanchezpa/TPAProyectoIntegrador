$(function(){
        ...
        $.each(json.msg, function(i,row){
           $('<option></option>', {text: row.nombrecarrera}).attr('value',row.idcarrera).appendTo('#cbCarrera'); 
        }
        );
    ...
    $.ajax({
        ...
        if(json.code===200)
        $.each(json.msg, function(i,row){
           $('<option></option>', {text: row.nombre_completo}).attr('value',row.materiaid).appendTo('#cbMateria'); 
        }
        );
